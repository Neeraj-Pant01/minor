    ...
    <div className="main-container">
      <div className='flex flex-col'>
        <div className='flex items-center gap-4 border-b-2 pb-2'>
          <Link className='text-[#0084B4] underline flex gap-4 items-center justify-center' to={'/'}>HOME <AiOutlineArrowRight /> </Link>
          <Link className='text-[#0084B4] underline flex gap-4 items-center justify-center' to={'/all'}>PRODUCTS <AiOutlineArrowRight /> </Link>
          <Link className='text-[#0084B4] underline flex gap-4 items-center justify-center' to={`/product/${item?._id}`}>{item.productName} <AiOutlineArrowRight /> </Link>
        </div>
        <div className='flex flex-col'>
          ...
          chat ?
            ...
            <>
              <div className="price-info border-2 rounded-md">
                ...
                <button className='bg-[#6f9a37] rounded-md py-2 px-4 text-[white]'>BUY NOW</button>
              </div>
     ...
     <div className='flex mt-16 flex-col items-center justify-center'>
      <h1 style={{lineHeight:"3rem"}} className='text-4xl text-[rgba(0,0,0,0.8)]'>Explore More Products</h1>
