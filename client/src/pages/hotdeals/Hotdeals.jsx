  ...
  return (
    ...
    <div className='hot-deals'>
        ...
        <div className='flex flex-col items-center mt-14 mb-16'>
          <h1 style={{lineHeight:"4rem"}} className='text-3xl font-semibold text-[rgba(0,0,0,0.6)]'>Explore Our Latest Feature</h1>
          <p className='w-[50%] text-center text-[grey] italic font-light text-sm'>Discover exclusive hourly deals! Whether you're buying or selling, seize the opportunity to snag incredible discounts or showcase your own products in limited-time offers. Act fast, as these deals won't last long!</p>
        </div>
